...
namespace CVMonitorExample
{
    ...
    class GridViewDataLimit
    {
        List<Limit> Limits { get; set; }
        public GridViewDataLimit(List<Limit> limits)
        {
            //int channelCount = 4;
            //Channel channel = Channel.Voltage_0;
            //for (int i = 0; i < channelCount; i++)
            //{
            //    Limit limit = new Limit(channel, upperLimit, lowerLimit);
            //}
    ...
    class Limit
    {
        ...
        public Limit(Channel channel, float lowerLimit, float upperLimit)
        {
            Channel = channel;
